...
*/
    ...
    if (!class_exists('DOPBSPDatabase')){
        class DOPBSPDatabase{
            ...
            private $db_version_extras_groups = 1.0;
            private $db_version_extras_groups_items = 1.0;
            ...
            private $db_version_translation = 1.0;
            private $db_version_woocommerce = 1.0;
            ...
            function __construct(){
                ...
                if (DOPBSP_CONFIG_INIT_DATABASE
                    ...
                    update_option('DOPBSP_db_version_woocommerce', '0.1');
                }
            }
...
// Database
            ...
            function init(){
                ...
                if ($this->db_version != (float)$current_db_version){
                    ...
                    $current_db_version_woocommerce = get_option('DOPBSP_db_version_woocommerce');
                    ...
                    $this->db_version_woocommerce != $current_db_version_woocommerce ? dbDelta($sql_woocommerce):'';
                    ...
                    $current_db_version_woocommerce == '' ? add_option('DOPBSP_db_version_woocommerce', $this->db_version_woocommerce):
                                                            update_option('DOPBSP_db_version_woocommerce', $this->db_version_woocommerce);
