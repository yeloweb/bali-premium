...
?>
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('addons-filters-search')" id="DOPBSP-inputs-button-addons-filters-search" class="dopbsp-button"></a>
                                </div>
                                <div id="DOPBSP-inputs-addons-filters-search" class="dopbsp-inputs-wrapper">
                                    <div class="dopbsp-input-wrapper ">     
                                        ...
                                        <input type="text" name="DOPBSP-addons-search" id="DOPBSP-addons-search" class="dopbsp-left " value="" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPAddons.search();}" onpaste="DOPBSPAddons.search()" onblur="DOPBSPAddons.search()">     
                                    </div>
                                </div>
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide dopbsp-last">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('addons-filters-categories')" id="DOPBSP-inputs-button-addons-filters-categories" class="dopbsp-button"></a>
                                </div>
...
?>
                                    <div class="dopbsp-input-wrapper dopbsp-last">
                                        <input type="checkbox" name="DOPBSP-addons-category-<?php echo $key; ?>" id="DOPBSP-addons-category-<?php echo $key; ?>" checked="checked" onchange="DOPBSPAddons.category('<?php echo $key; ?>')">
