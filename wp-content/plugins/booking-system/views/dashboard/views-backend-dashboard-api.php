...
?>
            <section class="dopbsp-content-wrapper dopbsp-responsive-hidden" >
                <div class="dopbsp-box-header dopbsp-hide">
                    ...
                    <a href="javascript:DOPBSP.toggleBox('api')" id="DOPBSP-box-button-api" class="dopbsp-button"></a>
                </div>
                <div id="DOPBSP-box-api" class="dopbsp-box-wrapper">
                    ...
                    <a href="javascript:DOPBSPApi.reset(<?php echo wp_get_current_user()->ID; ?>);" target="_blank" class="dopbsp-button dopbsp-reset-api-key dopbsp-right"><span class="dopbsp-info"><?php echo $DOPBSP->text('DASHBOARD_API_RESET'); ?></span></a>
                </div>
            </section>
<?php
            }
