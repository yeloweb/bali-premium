 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-extra-'.$id.'" id="DOPBSP-extra-'.$id.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPExtra.edit(\'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPExtra.edit(\'text\', \''.$id.'\', this.value)" onblur="DOPBSPExtra.edit(\'text\', \''.$id.'\', this.value, true)" />');
