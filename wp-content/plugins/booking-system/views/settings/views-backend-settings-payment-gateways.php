...
?>
                <div class="dopbsp-inputs-header <?php echo $settings_payment->address_billing_enabled == 'true' ? 'dopbsp-hide':'dopbsp-display'; ?>">
                    ...
                    <a href="javascript:DOPBSP.toggleInputs('payment-gateways-address-billing')" id="DOPBSP-inputs-button-payment-gateways-address-billing" class="dopbsp-button"></a>
                </div>
...
?>
                <div class="dopbsp-inputs-header <?php echo $settings_payment->address_shipping_enabled == 'true' ? 'dopbsp-hide':'dopbsp-display'; ?>">
                    ...
                    <a href="javascript:DOPBSP.toggleInputs('payment-gateways-address-shipping')" id="DOPBSP-inputs-button-payment-gateways-address-shipping" class="dopbsp-button"></a>
                </div>
