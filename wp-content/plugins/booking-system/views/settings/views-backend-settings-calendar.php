...
?>
                    <div class="dopbsp-input-wrapper">
                        ...
                        <div class="dopbsp-checkboxes-wrapper">
                            <input type="checkbox" name="DOPBSP-settings-days-available-0" id="DOPBSP-settings-days-available-0"<?php echo $days_available[0] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')" />
                            <label class="dopbsp-for-checkbox" for="DOPBSP-settings-days-available-0"><?php echo $DOPBSP->text('DAY_SUNDAY'); ?></label>
                            <br class="dopbsp-clear" />
                            <input type="checkbox" name="DOPBSP-settings-days-available-1" id="DOPBSP-settings-days-available-1"<?php echo $days_available[1] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')" />
                            <label class="dopbsp-for-checkbox" for="DOPBSP-settings-days-available-1"><?php echo $DOPBSP->text('DAY_MONDAY'); ?></label>
                            <br class="dopbsp-clear" />
                            <input type="checkbox" name="DOPBSP-settings-days-available-2" id="DOPBSP-settings-days-available-2"<?php echo $days_available[2] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')" />
                            <label class="dopbsp-for-checkbox" for="DOPBSP-settings-day-available-2"><?php echo $DOPBSP->text('DAY_TUESDAY'); ?></label>
                            <br class="dopbsp-clear" />
                            <input type="checkbox" name="DOPBSP-settings-days-available-3" id="DOPBSP-settings-days-available-3"<?php echo $days_available[3] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')" />
                            <label class="dopbsp-for-checkbox" for="DOPBSP-settings-days-available-3"><?php echo $DOPBSP->text('DAY_WEDNESDAY'); ?></label>
                            <br class="dopbsp-clear" />
                            <input type="checkbox" name="DOPBSP-settings-days-available-4" id="DOPBSP-settings-days-available-4"<?php echo $days_available[4] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')"  />
                            <label class="dopbsp-for-checkbox" for="DOPBSP-settings-days-available-4"><?php echo $DOPBSP->text('DAY_THURSDAY'); ?></label>
                            <br class="dopbsp-clear" />
                            <input type="checkbox" name="DOPBSP-settings-days-available-5" id="DOPBSP-settings-days-available-5"<?php echo $days_available[5] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')" />
                            <label class="dopbsp-for-checkbox" for="DOPBSP-settings-days-available-5"><?php echo $DOPBSP->text('DAY_FRIDAY'); ?></label>
                            <br class="dopbsp-clear" />
                            <input type="checkbox" name="DOPBSP-settings-days-available-6" id="DOPBSP-settings-days-available-6"<?php echo $days_available[6] == 'true' ? ' checked="checked"':'' ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'checkbox', 'days_available')" />
                ...
                <div id="DOPBSP-inputs-calendar-sidebar-settings" class="dopbsp-inputs-wrapper">
                    <div class="dopbsp-input-wrapper">
                        ...
                        <ul id="DOPBSP-settings-sidebar-styles" class="dopbsp-sidebar-styles">
                            <li id="DOPBSP-settings-sidebar-style1"<?php echo $settings_calendar->sidebar_style == 1 ? ' class="dopbsp-selected"':''; ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'sidebar-style', 'sidebar_style', 1)"></li>
                            <li id="DOPBSP-settings-sidebar-style2"<?php echo $settings_calendar->sidebar_style == 2 ? ' class="dopbsp-selected"':''; ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'sidebar-style', 'sidebar_style', 2)"></li>
                            <li id="DOPBSP-settings-sidebar-style3"<?php echo $settings_calendar->sidebar_style == 3 ? ' class="dopbsp-selected"':''; ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'sidebar-style', 'sidebar_style', 3)"></li>
                            <li id="DOPBSP-settings-sidebar-style4"<?php echo $settings_calendar->sidebar_style == 4 ? ' class="dopbsp-selected"':''; ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'sidebar-style', 'sidebar_style', 4)"></li>
                            <li id="DOPBSP-settings-sidebar-style5"<?php echo $settings_calendar->sidebar_style == 5 ? ' class="dopbsp-selected"':''; ?> onclick="DOPBSPSettings.set('<?php echo $id; ?>', 'calendar', 'sidebar-style', 'sidebar_style', 5)"></li>
                        </ul>
