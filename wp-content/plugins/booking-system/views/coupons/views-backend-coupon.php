...
<?php
                echo $this->getLanguages('DOPBSP-coupon-language',
                                         'DOPBSPCoupon.display(undefined, false)',
                                         $language,
                                         'dopbsp-left');
?>
 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-coupon-'.$id.'" id="DOPBSP-coupon-'.$id.'" class="'.$input_class.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPCoupon.edit(\'text\', \''.$id.'\', this.value);}" onchange="DOPBSPCoupon.edit(\'text\', \''.$id.'\', this.value)" onpaste="DOPBSPCoupon.edit(\'text\', \''.$id.'\', this.value)" onblur="DOPBSPCoupon.edit(\'text\', \''.$id.'\', this.value, true)" />');
                
                if ($code_help != '') {
                    array_push($html, '     <a href="javascript:void(0)" onclick="DOPBSPCoupon.generateCode();" target="_blank" class="dopbsp-button dopbsp-generate-code"><span class="dopbsp-info">'.$code_help.'</span></a>');
                }
            ...
            function displaySelectInput($args = array()){
                ...
                array_push($html, ' <div class="dopbsp-input-wrapper '.$container_class.'">');
                array_push($html, '     <label for="DOPBSP-coupon-'.$id.'">'.$label.'</label>');
                array_push($html, '     <select name="DOPBSP-coupon-'.$id.'" id="DOPBSP-coupon-'.$id.'" class="dopbsp-left '.$input_class.'" onchange="DOPBSPCoupon.edit(\'select\', \''.$id.'\', this.value)">');
