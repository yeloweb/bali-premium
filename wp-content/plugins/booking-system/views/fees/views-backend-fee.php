 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-fee-'.$id.'" id="DOPBSP-fee-'.$id.'" class="'.$input_class.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPFee.edit(\'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPFee.edit(\'text\', \''.$id.'\', this.value)" onblur="DOPBSPFee.edit(\'text\', \''.$id.'\', this.value, true)" />');
            ...
            function displaySelectInput($args = array()){
                ...
                array_push($html, ' <div class="dopbsp-input-wrapper '.$container_class.'">');
                array_push($html, '     <label for="DOPBSP-fee-'.$id.'">'.$label.'</label>');
                array_push($html, '     <select name="DOPBSP-fee-'.$id.'" id="DOPBSP-fee-'.$id.'" class="dopbsp-left '.$input_class.'" onchange="DOPBSPFee.edit(\'select\', \''.$id.'\', this.value)">');
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-fee-'.$id.'-'.$fee_id.'" id="DOPBSP-fee-'.$id.'-'.$fee_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPFee.edit(\'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
