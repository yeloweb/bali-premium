...
?>
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('themes-filters-search')" id="DOPBSP-inputs-button-themes-filters-search" class="dopbsp-button"></a>
                                </div>
                                <div id="DOPBSP-inputs-themes-filters-search" class="dopbsp-inputs-wrapper">
                                    <div class="dopbsp-input-wrapper ">     
                                        ...
                                        <input type="text" name="DOPBSP-themes-search" id="DOPBSP-themes-search" class="dopbsp-left " value="" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPThemes.search();}" onpaste="DOPBSPThemes.search()" onblur="DOPBSPThemes.search()" />     
                                    </div>
                                </div>
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide dopbsp-last">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('themes-filters-tags')" id="DOPBSP-inputs-button-themes-filters-tags" class="dopbsp-button"></a>
                                </div>
