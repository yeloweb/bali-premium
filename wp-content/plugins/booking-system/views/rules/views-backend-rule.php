 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-rule-'.$id.'" id="DOPBSP-rule-'.$id.'" class="'.$input_class.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPRule.edit(\'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPRule.edit(\'text\', \''.$id.'\', this.value)" onblur="DOPBSPRule.edit(\'text\', \''.$id.'\', this.value, true)" />');
