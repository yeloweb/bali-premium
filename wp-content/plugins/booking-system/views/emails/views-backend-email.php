 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-email-'.$id.'" id="DOPBSP-email-'.$id.'" class="'.$input_class.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPEmail.edit(\''.$template.'\', \'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPEmail.edit(\''.$template.'\', \'text\', \''.$id.'\', this.value)" onblur="DOPBSPEmail.edit(\''.$template.'\', \'text\', \''.$id.'\', this.value, true)" />');
            ...
            function displayTextarea($args = array()){
                ...
                array_push($html, ' <div class="dopbsp-input-wrapper '.$container_class.'">');
                array_push($html, '     <label for="DOPBSP-email-'.$id.'">'.$label.'</label>');
                array_push($html, '     <textarea name="DOPBSP-email-'.$id.'" id="DOPBSP-email-'.$id.'" cols="" rows="12" class="'.$input_class.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPEmail.edit(\''.$template.'\', \'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPEmail.edit(\''.$template.'\', \'text\', \''.$id.'\', this.value)" onblur="DOPBSPEmail.edit(\''.$template.'\', \'text\', \''.$id.'\', this.value, true)">'.$value.'</textarea>');
                array_push($html, ' </div>');
