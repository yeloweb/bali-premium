 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-discount-'.$id.'" id="DOPBSP-discount-'.$id.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPDiscount.edit(\'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPDiscount.edit(\'text\', \''.$id.'\', this.value)" onblur="DOPBSPDiscount.edit(\'text\', \''.$id.'\', this.value, true)" />');
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-discount-'.$id.'-'.$discount_id.'" id="DOPBSP-discount-'.$id.'-'.$discount_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPDiscount.edit(\'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
