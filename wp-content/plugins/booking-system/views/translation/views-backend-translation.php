...
-->
        <div class="dopbsp-main dopbsp-hidden">
            <div class="dopbsp-translation-header">
                ...
                <input type="button" name="DOPBSP-translation-manage-languages" id="DOPBSP-translation-manage-languages" class="dopbsp-right" value="<?php echo $DOPBSP->text('LANGUAGES_MANAGE'); ?>" onclick="DOPBSPLanguages.display()" />
...
?>
                        <tr>
                            ...
                            <td>
                                <textarea name="DOPBSP-translation-<?php echo $item->id; ?>" id="DOPBSP-translation-<?php echo $item->id; ?>" rows="1" cols="" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPTranslation.edit(<?php echo $item->id; ?>, '<?php echo $language; ?>', this.value);}" onpaste="DOPBSPTranslation.edit(<?php echo $item->id; ?>, '<?php echo $language; ?>', this.value)" onblur="DOPBSPTranslation.edit(<?php echo $item->id; ?>, '<?php echo $language; ?>', this.value, true)"><?php echo $translation_text; ?></textarea>
                            </td>
                        </tr>
<?php
                }
