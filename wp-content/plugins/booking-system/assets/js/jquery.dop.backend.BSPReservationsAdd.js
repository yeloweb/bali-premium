                ...
                for (i=0; i<form.length; i++){
                    ...
                    switch (formField['type']){
                        ...
                        case 'text':
                            ...
                            HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-form-field-warning'+ID+'_'+formField['id']+'" class="dopbsp-button dopbsp-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+formField['translation']+' '+(formField['is_email'] === 'true' ? methods_form.text['invalidEmail']:methods_form.text['required'])+'</span></a>');
                            break;
                        case 'textarea':
                            /*
                             * Textarea field.
            ...
            payment: {
                ...
                address_billing: {
                     ...
                     */
                        ...
                        HTML.push('<div class="dopbsp-inputs-header dopbsp-hide">');
                        HTML.push(' <h3>'+methods_order.text['addressBilling']+'</h3>');
                        HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-payment-address-billing'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-payment-address-billing'+ID+'" class="dopbsp-button"></a>');
                        HTML.push('</div>');
                        HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-payment-address-billing'+ID+'" class="dopbsp-inputs-wrapper">');
                        
                        HTML.push(' <div id="DOPBSPReservationsAdd-payment-address-billing-message'+ID+'" class="dopbsp-message">'+methods_order.text['addressSelectPaymentMethod']+'</div>');
                        ...
                        for (i=0; i<fields.length; i++){
                            switch (fields[i]['key']){
                                case 'country':
                                    ...
                                    HTML.push('     <label for="DOPBSPReservationsAdd-payment-address-billing-'+fields[i]['id']+ID+'">'+methods_order.text[fields[i]['text']]+' <span class="dopbsp-required">*</span></label>');
                                    ...
                                    HTML.push('     </select>');
                                    HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-payment-address-billing-'+fields[i]['id']+'-warning'+ID+'" class="dopbsp-button dopbsp-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+methods_order.text[fields[i]['text']]+' '+methods_form.text['required']+'</span></a>');
                                    HTML.push(' </div>');           
                                ...
                                default:
                                    ...
                                    HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-payment-address-billing-'+fields[i]['id']+'-warning'+ID+'" class="dopbsp-button dopbsp-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+methods_order.text[fields[i]['text']]+' '+(fields[i]['key'] === 'email' ? methods_form.text['invalidEmail']:methods_form.text['required'])+'</span></a>');
                                    HTML.push(' </div>');
                            }
                        }
                        HTML.push('</div>');
                     ...
                     */
                        ...
                        if (paymentMethod === 'none'
                            ...
                            $('#DOPBSPReservationsAdd-payment-address-billing-message'+ID).css('display', 'block')
                                                                                          .html(data['enabled'] ? methods_order.text['addressSelectPaymentMethod']:methods_order.text['addressBillingDisabled']);
                            return false;
                        }
                        else{
                ...
                address_shipping: {
                     ...
                     */
                        ...
                        HTML.push('<div class="dopbsp-inputs-header dopbsp-hide">');
                        HTML.push(' <h3>'+methods_order.text['addressShipping']+'</h3>');
                        HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-payment-address-shipping'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-payment-address-shipping'+ID+'" class="dopbsp-button"></a>');
                        HTML.push('</div>');
                        HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-payment-address-shipping'+ID+'" class="dopbsp-inputs-wrapper">');
                        
                        HTML.push(' <div id="DOPBSPReservationsAdd-payment-address-shipping-message'+ID+'" class="dopbsp-message">'+methods_order.text['addressSelectPaymentMethod']+'</div>');
                        ...
                        HTML.push('     <label class="dopbsp-for-checkbox" for="DOPBSPReservationsAdd-payment-address-shipping-copy'+ID+'">'+methods_order.text['addressShippingCopy']+'</label>');
                        HTML.push(' </div>');     
                        ...
                        for (i=0; i<fields.length; i++){
                            switch (fields[i]['key']){
                                case 'country':
                                    ...
                                    HTML.push('     <label for="DOPBSPReservationsAdd-payment-address-shipping-'+fields[i]['id']+ID+'">'+methods_order.text[fields[i]['text']]+' <span class="dopbsp-required">*</span></label>');
                                    ...
                                    HTML.push('     </select>');
                                    HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-payment-address-shipping-'+fields[i]['id']+'-warning'+ID+'" class="dopbsp-button dopbsp-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+methods_order.text[fields[i]['text']]+' '+methods_form.text['required']+'</span></a>');
                                    HTML.push(' </div>');           
                                ...
                                default:
                                    ...
                                    HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-payment-address-shipping-'+fields[i]['id']+'-warning'+ID+'" class="dopbsp-button dopbsp-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+methods_order.text[fields[i]['text']]+' '+(fields[i]['key'] === 'email' ? methods_form.text['invalidEmail']:methods_form.text['required'])+'</span></a>');
                                    HTML.push(' </div>');
                            }
                        }
                        HTML.push('</div>');
                     ...
                     */
                        ...
                        if (paymentMethod === 'none'
                            ...
                            $('#DOPBSPReservationsAdd-payment-address-shipping-message'+ID).css('display', 'block')
                                                                                           .html(data['enabled'] ? methods_order.text['addressSelectPaymentMethod']:methods_order.text['addressShippingDisabled']);
