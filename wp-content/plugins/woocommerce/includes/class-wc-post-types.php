	...
	public static function register_post_types() {
		...
		register_post_type( 'product',
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							'name'                  => __( 'Villas', 'woocommerce' ),
							'singular_name'         => __( 'Villa', 'woocommerce' ),
							'menu_name'             => _x( 'Villas', 'Admin menu name', 'woocommerce' ),
							'add_new'               => __( 'Add Villa', 'woocommerce' ),
							'add_new_item'          => __( 'Add New Villa', 'woocommerce' ),
							'edit'                  => __( 'Edit', 'woocommerce' ),
							'edit_item'             => __( 'Edit Villa', 'woocommerce' ),
							'new_item'              => __( 'New Villa', 'woocommerce' ),
							'view'                  => __( 'View Villa', 'woocommerce' ),
							'view_item'             => __( 'View Villa', 'woocommerce' ),
							'search_items'          => __( 'Search Villas', 'woocommerce' ),
							'not_found'             => __( 'No Villas found', 'woocommerce' ),
							'not_found_in_trash'    => __( 'No Villas found in trash', 'woocommerce' ),
							'parent'                => __( 'Parent Villa', 'woocommerce' ),
							'featured_image'        => __( 'Villa Image', 'woocommerce' ),
							'set_featured_image'    => __( 'Set Villa image', 'woocommerce' ),
							'remove_featured_image' => __( 'Remove Villa image', 'woocommerce' ),
							'use_featured_image'    => __( 'Use as Villa image', 'woocommerce' ),
						),
					'description'         => __( 'This is where you can add new Villas to your store.', 'woocommerce' ),
					'public'              => true,
					'show_ui'             => true,
					...
					'menu_position' 	=> 5, // Intégrate by Cloé
					'menu_icon'			 => '',  // Intégrate by Cloé
